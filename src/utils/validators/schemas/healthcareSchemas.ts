...
export const healthcareProviderBaseSchema = z.object({
  name: z
    .string()
    .min(2, ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_NAME)
    .max(150, ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_NAME)
    .regex(
      /^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\-&.,()0-9]+$/,
      ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_NAME_FORMAT
    ),

  code: z
    .string()
    .min(2, ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_CODE)
    .max(20, ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_CODE)
    .regex(
      /^[a-zA-Z0-9\-_]+$/,
      ERROR_MESSAGES.HEALTHCARE_PROVIDER.INVALID_HEALTHCARE_CODE_FORMAT
    )
    .optional()
    .nullable()
